...
class LearningFood extends StatefulWidget {
  const LearningFood({super.key});

  @override
  LearningFoodState createState() => LearningFoodState();
}

class LearningFoodState extends State<LearningFood>
{
  int currentIndex=0;
  List<Food> foods=[
    Food(title:'ЈАБОЛКА', image: 'assets/food/apple.png', audio: 'assets/audio/hello.mp3'),
  ];
   @override
  void initState() {
    super.initState();
